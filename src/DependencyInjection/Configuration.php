            ...
            ->children()
                ->arrayNode('tools')
                    ...
                    ->children()
                        ...
                        ->booleanNode('shipments')->defaultTrue()->info('Global shipment list/get/ship/resend-email tools.')->end()
                        ->booleanNode('payments')->defaultTrue()->info('Global payment list/get tools.')->end()
